...
public interface InterfaceAdminService {
    ...
    /**
     * Récupère tous les bébés d'un parent donné.
     * @param parentId ID du parent
     * @return Optional contenant la liste des bébés si existants, sinon une Optional vide
     */
    List<Bebe> getBebesByParentId(Long parentId);
    /**
     * Récupère un parent par son ID.
     * @param id ID du parent
     * @return Parent trouvé
     */
